...
<head>
    ...
    <link href="../../css2-2.css?family=Russo+One&display=swap" rel="stylesheet">
    <link href="../../css2-5.css?family=Exo+2:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
    <link href="../../css2.css?family=Public+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
                        ...
                        <div class="footer-contact">
                            <ul>
                                ...
                                <li class="social-app">
                                    ...
                                    <ul>
                                        <li class="mb-0">
                                            <a href="../../store/apps.html" target="_blank">
                                                <img src="../assets/images/playstore.svg" class="blur-up lazyload" alt="">
                                            </a>
                                        </li>
                                        <li class="mb-0">
                                            <a href="../../in/app-store/index.htm" target="_blank">
