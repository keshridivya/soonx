											...
											<ul>
												<li>
													<a class="btn btn-solid"
														href="<?= base_url('admin/addads') ?>">Add Ads</a>
												</li>
											</ul>
										</div>
									</div>
										...
										<div class="table-responsive">
											<table class="table all-package coupon-list-table table-hover theme-table"
												...
												<tbody>
                                                    ...
                                                    ?>
													<tr>
														<td><img src="<?= base_url() ?>uploads/ads/<?= $ads['logo'] ?>" alt="" width="50"></td>
														<td class="theme-color"><?= $ads['ads_name'] ?></td>
														<td><?= $ads['desc'] ?></td>
														<td><?= $ads['address'] ?></td>
														<td><?= $ads['contact'] ?></td>
														<td class="menu-status">
															<span
																class="<?php echo ($ads['status'] == '1') ? 'success' : 'danger'; ?>"><?php echo ($ads['status'] == '1') ? 'Active' : 'Deactive'; ?></span>
														</td>
														<td>
															<ul>
																<li>
																	<a href="<?= base_url() ?>admin/editads/<?= $ads['id'] ?>">
	...
	<script>
		document.addEventListener('DOMContentLoaded', function () {
			...
			function deleteTableRow(rowId) {
				$.ajax({
					url: "<?php echo base_url('admin/adsdelete'); ?>",
					type: "POST",
					data: {
						row_id: rowId
					},
