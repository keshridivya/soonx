                                ...
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        ...
                                        <form class="d-inline-flex">
                                            <a href="<?= base_url('admin/addofferslider') ?>" class="align-items-center btn btn-theme d-flex">
                                            ...
                                            <table class="table all-package theme-table" id="table_id">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                        <?= $offerslider['slider_name']; ?>
                                                        </td>
                                                        <td><?= $offerslider['for']; ?></td>

                                                        <td><?= $offerslider['button']; ?></td>

                                                        <td>
                                                            <ul>
                                                                <li>
                                                                    <a href="<?= base_url() ?>admin/editofferslider/<?= $offerslider['id'] ?>">
                                                                        <i class="ri-pencil-line"></i>
                                                                    </a>
                                                                </li>

                                                                <li>
                                                                    <a href="javascript:void(0)" id="delete" class="delete-button" data-row="<?= $offerslider['id'] ?>">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function deleteTableRow(rowId) {
        $.ajax({
            url: "<?php echo base_url('admin/offersliderdelete'); ?>",
            type: "POST",
            data: {row_id: rowId},
