                ...
                <div>
                    ...
                    <div class="logo-icon-wrapper">
                        <a href="index.html">
                            ...
                            <img class="img-fluid main-logo main-dark" src="<?= base_url() ?>assets/admin/images/logo/logo-white.png" alt="logo">
                        </a>
                    </div>
                            ...
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        ...
                                        <li>
                                            <a href="<?= base_url('admin/addCategory') ?>">Add New Category</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="<?= base_url('admin/subcategory') ?>">Sub Category List</a>
                                        </li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="<?= base_url('admin/brand') ?>">Brand List</a>
                                        </li>

                                        <li>
                                            <a href="<?= base_url('admin/addbrand') ?>">Add New Brand</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="<?= base_url('admin/product') ?>">Prodcts</a>
                                        </li>
                                ...
                                <li class="sidebar-list">
                                    ...
                                    <ul class="sidebar-submenu">
                                        <li>
                                            <a href="<?= base_url('admin/offerslider') ?>">Offer Slider List</a>
                                        </li>

                                        <li>
                                            <a href="<?= base_url('admin/addofferslider') ?>">Add New Offer Slider</a>
                                        </li>
                                    </ul>
                                </li>
