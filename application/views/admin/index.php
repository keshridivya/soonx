...
<body>
    ...
    <section class="log-in-section section-b-space">
        <a href="" class="logo-login"><img src="<?= base_url() ?>/assets/admin/images/logo/1.png" class="img-fluid"></a>
                            ...
                            <form class="row g-4" method="post" action="<?php echo base_url('admin/process_login'); ?>">
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating log-in-form">
                                        <input type="text" class="form-control" id="email" placeholder="Email Address" name="username">
                            ...
                            <ul>
                                <li>
                                    <a href="https://www.google.com/" class="btn google-button w-100">
                                        <img src="<?= base_url() ?>/assets/admin/images/inner-page/google.png" class="blur-up lazyload"
                                            alt=""> Log In with Google
                                    </a>
                                </li>
                                <li>
                                    <a href="https://www.facebook.com/" class="btn google-button w-100">
                                        <img src="<?= base_url() ?>/assets/admin/images/inner-page/facebook.png" class="blur-up lazyload"
