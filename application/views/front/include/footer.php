                ...
                <div class="row g-md-4 gy-sm-5">
                    <div class="col-xxl-3 col-xl-4 col-sm-6">
                        ...
                        <ul class="social-icon">
                            <li class="light-bg">
                                <a href="../../index.htm" class="footer-link-color">
                                    <i class="fab fa-facebook-f"></i>
                                </a>
                            </li>
                            <li class="light-bg">
                                <a href="../../v3/signin/identifier.html?flowName=GlifWebSignIn&flowEntry=ServiceLogin" class="footer-link-color">
                            ...
                            <li class="light-bg">
                                <a href="../../index-1.htm" class="footer-link-color">
                                    <i class="fab fa-instagram"></i>
                                </a>
                            </li>
                            <li class="light-bg">
                                <a href="../../index-2.htm" class="footer-link-color">
