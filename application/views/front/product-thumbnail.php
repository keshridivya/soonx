                    ...
                    <div class="row g-4">
                                ...
                                <div class="row g-2">
                                    <div class="col-xxl-10 col-lg-12 col-md-10 order-xxl-2 order-lg-1 order-md-2">
                                        ...
                                        <div>
                                                <div class="slider-image">
                                                    <img src="<?= base_url() ?>uploads/product_thumb_image/<?= $product->thumbnail_image ?>" data-zoom-image="<?= base_url() ?>uploads/product_thumb_image/<?= $product->thumbnail_image ?>" class="img-fluid image_zoom_cls-2 blur-up lazyload" alt="">
                                                </div>
                                            </div>
                                            <?php
                                            $product_string = $product->multiple_images;
                                            // print_r()
                                            $product_img = explode(",", $product_string);
                                            foreach($product_img as $product_imgs){
                                            ?>
                                            <div>
                                                <div class="slider-image">
                                                    <img src="<?= base_url() ?>uploads/product_img/<?= $product_imgs ?>" id="img-1" data-zoom-image="<?= base_url() ?>uploads/product_img/<?= $product_imgs ?>" class="img-fluid image_zoom_cls-0 blur-up lazyload" alt="">
                                                </div>
                                            </div>
                                            <?php } ?>
                                    ...
                                    <div class="col-xxl-2 col-lg-12 col-md-2 order-xxl-1 order-lg-2 order-md-1">
                                        ...
                                        <?php
                                            ...
                                            <div>
                                                <div class="sidebar-image">
                                                    <img src="<?= base_url() ?>uploads/product_img/<?= $product_imgs ?>" class="img-fluid blur-up lazyload" alt="">
                                                </div>
                                            </div>
                                            <?php } ?>
                        ...
                        <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="right-box-contain">
                                ...
                                <div class="buy-box">
                                    <a href="javascript:(0)">
                                    <span class="heartspan1" data-id="<?= $product->id ?>">
										<?php
                                                        ...
                                                        <ul class="review-list">
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image">
                                                                            <img src="../assets/images/review/2.jpg" class="img-fluid blur-up lazyload" alt="">
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <div class="people-box">
                                                                    <div>
                                                                        <div class="people-image">
                                                                            <img src="../assets/images/review/3.jpg" class="img-fluid blur-up lazyload" alt="">
                                                                        </div>
                                                                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="cart-content">
                        ...
                        <div class="add-btn">
                            <a class="btn theme-bg-color text-white wishlist-btn" href="wishlist.html"><i class="fa fa-bookmark"></i> Wishlist</a>
                            <a class="btn theme-bg-color text-white" href="cart.html"><i class="fas fa-shopping-cart"></i> Add To Cart</a>
                        </div>
                    </div>
                </div>
            </div>
